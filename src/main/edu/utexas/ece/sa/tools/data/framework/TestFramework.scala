package edu.utexas.ece.sa.tools.data.framework

import edu.utexas.ece.sa.tools.testobjects.GeneralTestClass
import edu.utexas.ece.sa.tools.testobjects.JUnitTestCaseClass
import edu.utexas.ece.sa.tools.testobjects.JUnitTestClass
import edu.utexas.ece.sa.tools.testobjects.JUnit5TestClass
